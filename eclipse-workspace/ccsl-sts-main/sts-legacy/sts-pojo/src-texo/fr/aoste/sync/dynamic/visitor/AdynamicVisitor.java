...
/**
 * A Default abstract Visitor for the package '<em><b>dynamic</b></em>'. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public abstract class AdynamicVisitor<T> implements IdynamicVisitor<T> {
	 ...
	 * @generated
	 */
	public T visit(DynamicTransitionSystem e) {
		return null;
	}
