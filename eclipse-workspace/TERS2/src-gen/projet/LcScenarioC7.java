...
public class LcScenarioC7 implements ISpecificationBuilder {
	static public LcScenarioC7 INSTANCE = new LcScenarioC7();
	private LcScenarioC7 () {
		// SINGLETON
	}
	@Override
	public void build(ISimpleSpecification simple) {
		...
		simple.causality("Focus", "Inattentive");
