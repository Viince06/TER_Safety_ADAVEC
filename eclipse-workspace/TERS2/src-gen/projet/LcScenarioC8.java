...
public class LcScenarioC8 implements ISpecificationBuilder {
	static public LcScenarioC8 INSTANCE = new LcScenarioC8();
	private LcScenarioC8 () {
		// SINGLETON
	}
	@Override
	public void build(ISimpleSpecification simple) {
		...
		simple.causality("Focus", "Inactive");
