...
public class LcChangeModeOld implements ISpecificationBuilder {
	static public LcChangeModeOld INSTANCE = new LcChangeModeOld();
	private LcChangeModeOld () {
		// SINGLETON
	}
	@Override
