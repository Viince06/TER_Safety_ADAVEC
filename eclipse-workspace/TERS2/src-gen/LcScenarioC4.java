...
public class LcScenarioC4 implements ISpecificationBuilder {
	static public LcScenarioC4 INSTANCE = new LcScenarioC4();
	private LcScenarioC4 () {
		// SINGLETON
	}
	@Override
	public void build(ISimpleSpecification simple) {
		...
		simple.causality("Health", "Death");
		
		simple.union("FinalMode", "Automatic", "Manual", "MRM");
		
		simple.causality("FinalMode", "MRM");
		
		simple.delayFor("Transfer", "Death", 5, -1, "Seconds");
		
		simple.causality("Death", "FinalMode");
