...
public class OldChangeModes implements ISpecificationBuilder {
	static public OldChangeModes INSTANCE = new OldChangeModes();
	private OldChangeModes () {
		// SINGLETON
	}
	@Override
	...
	public static void main(String[] args) throws IOException {
		...
		MyScadeGenerator myScadeGen = new MyScadeGenerator(filePath, bodyFilePath);
