...
const MappingEntry scope_1_entries[10] = {
    /* 0 */ { MAP_OUTPUT, "o", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx.o, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 0 },
    ...
    /* 4 */ { MAP_LOCAL, "_L2", NULL, sizeof(ClockStatus), (size_t)&outputs_ctx._L2, &_Type_ClockStatus_Utils, NULL, NULL, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L3, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L4, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L5, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 7 },
    /* 8 */ { MAP_INSTANCE, "Utils::isPresent 1", NULL, sizeof(outC_isPresent_Utils), (size_t)&outputs_ctx.Context_isPresent_1, NULL, NULL, NULL, &scope_2, 1, 8 },
    /* 9 */ { MAP_INSTANCE, "Utils::isPresent 2", NULL, sizeof(outC_isPresent_Utils), (size_t)&outputs_ctx.Context_isPresent_2, NULL, NULL, NULL, &scope_2, 1, 9 }
};
const MappingScope scope_1 = {
    "Graphic_Scade::Exclusion/ Exclusion_Graphic_Scade",
    scope_1_entries, 10
};

const MappingEntry scope_0_entries[1] = {
    /* 0 */ { MAP_ROOT, "Graphic_Scade::Exclusion", NULL, 0, 0, NULL, NULL, NULL, &scope_1, 1, 0 }
};
